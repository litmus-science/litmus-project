...
SYSTEM_PROMPT = f"""You are an expert laboratory scientist and protocol designer. Your role is to
interpret natural language experiment descriptions and extract structured parameters for automated
cloud laboratory systems.
...
When given an experiment description (hypothesis, notes, type), extract all relevant experimental
parameters and return them in a structured JSON format that can be used by the cloud lab
translators.
...
EXPERIMENT_SCHEMAS = {
    ...
    "CELL_VIABILITY_IC50": {
        ...
        "properties": {
            ...
            "assay_type": {
                "type": "string",
                "enum": ["CELLTITER_GLO", "MTT", "MTS", "RESAZURIN", "LIVE_DEAD", "OTHER"],
            },
            ...
            "dose_range": {
                ...
                "properties": {
                    ...
                    "dilution_series": {
                        "type": "string",
                        "enum": ["2-fold", "3-fold", "half-log", "custom"],
                    },
                },
            },
...
Based on the above experiment description, extract the experimental parameters and return a JSON
object with:
...
6. A "confidence" key with a value from 0.0 to 1.0 indicating how confident you are in the
   interpretation
